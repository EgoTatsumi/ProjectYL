...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        if not self.aliens:
            ...
            # Увеличение уровня
            self.stats.level += 1
            self.stats.score += self.stats.level_score
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            ship_hit_sound = pygame.mixer.Sound('other_files/minus_hp.wav')
            ship_hit_sound.play()
    ...
    def _update_screen(self):
        ...
        pygame.display.flip()
        if pygame.sprite.spritecollide(self.ship, self.bonus, True):
